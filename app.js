...
function addProductLine(){const line=document.querySelector('.product-line').cloneNode(true);line.querySelectorAll('input').forEach(input=>input.value='');line.querySelector('.unit').value='L';line.querySelector('.remove-product').hidden=false;line.querySelector('.remove-product').onclick=()=>{line.remove();updateTotal()};bindProductLine(line);$('product-lines').appendChild(line);line.querySelector('.product').focus();updateTotal();}
